...
router.get("/dashboard", ensureAuthenticated, async function(req, res){
    ...
    activeTasks.reverse();
    planTasks.reverse();
    res.render('pages/dashboard_views/mainDashboard', { writeTasks: writeTasks, planTasks:planTasks, activeTasks:activeTasks, activePosts:activePosts, comments:comments, activeEvents:activeEvents, recruitTasks:recruitTasks});
    var t1 = performance.now();
